...
do
  ...
  python s1_fs_train.py --perclass 5 --epo ${j}
  printf 'FS training done\n'
  printf "epo ${j} Start 1st iter\n"
  python s2_fs_test_predict.py --load_model_path ./Params/fs_train_fs5.pth --perclass 5 --iter_idx 1 --epo ${j}
  ...
  do
    ...
    python s2_fs_test_predict.py --load_model_path ./Params/connect_area_train_fs5_iter$(($i - 1)).pth --perclass 5 --iter_idx ${i} --epo ${j}
